...
SECRET_KEY = 'django-insecure-=-!ylamw*atoh)oetaivd8dpwyphu(_1=15)*%dkls!fu^cueu'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'proyecto.peralta.26@gmail.com' 
EMAIL_HOST_PASSWORD = 'dvnkfdkywsjhwfwu'
